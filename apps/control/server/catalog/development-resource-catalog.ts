...
export const developmentResourceCatalog: ResourceCatalog = {
  skills: [
    {
      ...
      ...skillInformation(
        ...
        "Connect an approved HR Vector Database, then ask a specific policy question. The Skill returns an answer with the relevant policy context for review.",
      ),
      category: "HR",
    ...
    },
    {
      ...
      ...skillInformation(
        ...
        "Provide the employee role, location, and start date. Connect the approved onboarding Vector Database before requesting a personalized checklist.",
      ),
      category: "HR",
      trustLevel: "TRUSTED_SOURCE",
    ...
    },
    {
      ...
      ...skillInformation(
        "Customer Experience",
        "Support answers become inconsistent when Agents rely on memory instead of the current approved Vector Database.",
        ["Answer a product usage question", "Explain an approved troubleshooting procedure"],
        "Attach an approved product Vector Database and ask a focused question. The Skill should be configured to cite the material used for the answer.",
      ),
      category: "Customer Support",
      trustLevel: "TRUSTED_SOURCE",
      compatibleAgents: ["hermes", "openclaw", "openai"],
  ...
  specializations: [
    ...
    },
    {
      ...
      systemPrompt: "You are an HR support Agent. Answer employee questions using approved company policies and connected Vector Databases. Be clear about policy scope, protect confidential employee data, and escalate decisions that require a People Operations owner.",
