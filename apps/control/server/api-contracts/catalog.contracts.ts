...
export const catalogContracts = defineContracts([
  ...
  projectRoute({
    method: "post", path: "/agent-garden/agents", operationId: "registerGardenAgent",
    summary: "Register an Agent Garden entry", tags: ["Agent Garden"],
    request: { body: createAgentGardenEntrySchema },
    responses: { 201: response("Registered Agent", agentGardenEntrySchema) },
  }),
  projectRoute({
