  ...
  components: {
    ...
    schemas: {
      ...
      CreateModelRoutingInput: {
        ...
        properties: { name: { type: "string", minLength: 2, maxLength: 64 }, description: { type: "string" }, gatewayId: { type: "string" }, routingPolicy: { $ref: "#/components/schemas/ModelRoutingPolicy" }, complianceDomain: { type: "string", enum: ["GLOBAL", "CN_MAINLAND", "EU_EEA", "US", "UK", "APAC_EX_CN"] }, isDefault: { type: "boolean" }, keyPolicy: { type: "object" }, auditPolicy: { type: "object" }, modelGuardrailsEnabled: { type: "boolean", default: false } },
      },
      ModelRoutingPolicy: {
        oneOf: [
          {
