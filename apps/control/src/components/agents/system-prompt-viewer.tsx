...
export function SystemPromptViewer({ defaultPrompt, onApply, onOpenChange, open, prompt, specializationName }: {
        ...
        <div className="min-h-0 flex-1 space-y-3 overflow-y-auto p-6">
          ...
          <div className="flex items-start justify-between gap-4 text-xs">
            <span className={isValid ? "text-muted-foreground" : "text-destructive"}>
              {isValid ? (isDefault ? "Using the Role default." : "Customized for this Instance.") : "Enter at least 10 characters."}
            </span>
